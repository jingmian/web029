...
- [Zoomla!逐浪CMS卓越出品](#zoomla逐浪cms卓越出品)
  - [逐浪官方开源精品全站项目029：氿度伞一个有格调不失温度基于LBS定位的共享雨伞平台](#逐浪官方开源精品全站项目029：氿度伞一个有格调不失温度基于LBS定位的共享雨伞平台)
  - [本项目介绍](#本项目介绍)
- [开放性说明](#开放性说明)
  - [使用说明](#使用说明)
- [接口文档](#接口文档)
...
## 逐浪官方开源精品全站项目029：氿度伞一个有格调不失温度基于LBS定位的共享雨伞平台
...
这是一个-基于LBS定位的共享雨伞平台，一个会员可以有多重角色，可以商户提供租借雨伞服务，也可以是借伞用户，系统包含推广、分销、利润结算、提现省功能，移动优先，全面支持响应式，其特征包括：
- 服务端基于Zoomla!逐浪CMS开发
- 前端web呈现基于Boostrap 
...
![系统效果图3](demo-show-系统效果图/15.jpg)
![系统效果图3](demo-show-系统效果图/16.jpg)
